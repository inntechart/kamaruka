...
// resources
import { policy } from '../../../../resources/index';
    ...
    return <div className={ styles.enquiry }>
        <div className={ styles.enquiry__content }>
            <div className={ styles.enquiry__texts }>
                <h2 className={ styles.enquiry__content_heading }>Policy</h2>
                <Accordion
                    items={ policy }
        ...
        <aside style={{display: 'flex', justifyContent: 'space-between'}}>
            <div>
                <Square classname={ `contain pages` }
                        style={ { minHeight: '330px', maxHeight: '330px', marginTop: '10px' } }>
                    <img style={ { width: '90%' } } src={ Ann } alt="20 Year" />
                </Square>
                <Square classname={ `after green` }
                        style={ { backgroundImage: `url(${ Child })`, minHeight: '330px' } }>
                    <h3>Here to Help</h3>
                    <p>Positive choice change</p>
                </Square>
                <Square routeTo={'/enrolment/process'} classname={ `after lightblue` }
                        style={ { backgroundImage: `url(${ Comp })`, minHeight: '330px' } }>
                    <h3>Enrolment <br />
                        Process</h3>
                </Square>
                <Square classname={ `after orange` }
                        style={ { backgroundImage: `url(${ Teach })`, minHeight: '330px' } }>
                    <h3>
                        Intervention <br />
                        Program
                    </h3>
