...
const ForewordWrap = () => {
    return <div className={ styles.foreword }>
        <div className={ styles.foreword__intro }>
            <div className={ styles.foreword__descrs }>
                <h2 className={ styles.foreword_heading }>Foreword</h2>
                <div className={ `${ styles.foreword__descr } ${ styles.foreword_texts }` }>
                    <ForewordSection />
                </div>
            </div>
            <div className={ styles.foreword__side }>
        ...
        <div className={ styles.foreword__intro }>
            <div className={ styles.foreword__cubes }>
                <Cubes />
            </div>
            <div className={ styles.foreword__donate }>
                <Donations />
            </div>
        </div>
        <Arrows
