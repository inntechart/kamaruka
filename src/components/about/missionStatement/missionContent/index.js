...
import Teach from '../../../../assets/img/teach2.png';
...
const MissionWrap = () => {
    return <div className={ styles.mission }>
        <div className={ styles.mission__intro }>
            <div className={ styles.mission__descrs }>
                <h2 className={ styles.mission_heading }>Mission Statement</h2>
                <div className={ `${ styles.mission__descr } ${ styles.mission_texts }` }>
                <MissionSection />
                </div>
            </div>
            <div className={ styles.mission__side }>
        ...
        <div className={ styles.mission__intro }>
            <div className={styles.mission__cubes}>
                <Cubes />
            </div>
            <div className={styles.mission__donate}>
                <Donations
                />
            </div>
        </div>
