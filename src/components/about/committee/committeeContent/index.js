...
import CommitteeHeading from './committeHeading';
...
const CommitteeWrap = () => {
    ...
    return <div className={ styles.committee }>
        <div className={ styles.committee__intro }>
            <CommitteeHeading />
            <div className={ styles.committee__side }>
        ...
        <div className={ styles.committee__intro }>
            <div className={ styles.committee__cubes }>
                <Cubes />
            </div>
            <div className={ styles.committee__donate }>
                <Donations />
            </div>
        </div>
        <Arrows
